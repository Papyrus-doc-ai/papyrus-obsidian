...
import { App, Component, Editor, ItemView, MarkdownRenderer, MarkdownView, Setting, TFile, ViewStateResult, WorkspaceLeaf } from "obsidian";
...
export class GeneratorView extends ItemView {
	...
	constructor(leaf: WorkspaceLeaf, setting: GeneratorViewSettings, component: Component) {
		super(leaf);
